...
import com.spring.boot.config.WebConfiguration;
import com.spring.boot.model.User;
import com.spring.boot.param.LoginParam;
import com.spring.boot.param.RegisterParam;
...
public class IndexController {
	...
	public String login(@Valid LoginParam loginParam, BindingResult result, ModelMap model,
